...
export default function CalendarMonthInfo({ calendarItems, semester }) {
  ...
  const renderFirstMonth = () => {
    if (semester === 1) {
      return janEvents.map(el => {
        return (
          <div className="month-event-wrapper">
            <span className="calendar-panel-month-label">{el.month}</span>
      ...
      return sepEvents.map(el => {
        return (
          <div className="month-event-wrapper">
            <span className="calendar-panel-month-label">
              {el.month}
